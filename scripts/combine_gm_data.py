"""Combine GM executive data from 32 team files into single CSV.

This script reads all individual team GM/executive CSV files from data/raw/executives/
and combines them into a single processed file with standardized team codes.
...
def main() -> None:
    """Main entry point for combining GM data."""

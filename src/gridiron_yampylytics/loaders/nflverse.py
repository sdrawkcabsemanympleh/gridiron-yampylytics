...
def cache_nflverse_data(
    ...
    print(f"Cache location: {list(cache_dirs.values())[0]}")
    print("="*80)
    print()
    ...
    if dataset == "all":
        ...
        if seasons:
            print(f"Warning: {dataset} doesn't support season filtering. Ignoring seasons parameter.")
        try:
    ...
    print("\n" + "="*80)
    print(f"Data cached in: {list(cache_dirs.values())[0]}")
